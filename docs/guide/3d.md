...
[`surface`][pyplotrs.figure.Axes3D.surface] draws a colormapped surface over a
...
[`plot`][pyplotrs.figure.Axes3D.plot] (alias `plot3d`) draws a 3D polyline:
...
[`scatter`][pyplotrs.figure.Axes3D.scatter] (alias `scatter3d`) places
...
[`set`][pyplotrs.figure.Axes3D.set]:
