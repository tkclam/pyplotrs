//! figurs-render-raster: renders a [`figurs_core::Scene`] to a raster image
...
use figurs_core::kurbo::{Affine, PathEl, Point, Vec2};
use figurs_core::{
...
fn to_tiny_skia_path(geometry: &figurs_core::kurbo::BezPath) -> Option<tiny_skia::Path> {
...
mod tests {
    use super::*;
    use figurs_core::kurbo::{Circle, Point, Rect, Shape, Size};
    use figurs_core::{ClipPath, Color, FillRule, Group, MarkerNode, PathNode, Scene};
    ...
    fn marker_path() -> figurs_core::kurbo::BezPath {
