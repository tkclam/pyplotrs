//! figurs-core: the backend-agnostic Scene IR.
//!
...
///
/// Keeping this in `figurs-core` lets every backend (PDF embedding, raster
...
/// A run of glyphs that have already been shaped (via `figurs-text`) against
